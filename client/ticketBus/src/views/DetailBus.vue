      ...
      <div class="container">
        ...
        <form>
          <select
            ...
            v-model="noBangku"
          >
            <option selected>Nomor Bangku</option>
            <option v-for="bangku in listBangku">{{ bangku }}</option>
          </select>
          <button
            type="button"
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <h3 class="font-bold text-gray-800 dark:text-white">Pembelian Ticket</h3>
                <button
                  type="button"
              ...
              <div class="p-4 overflow-y-auto">
                <p class="mt-1 text-gray-800 dark:text-gray-400">
                  Confirm untuk detail pembelian tiket
                </p>
              </div>
              <div
...
export default {
  ...
  computed: {
    beliTicket() {
      let temp = [this.$route.params.id, this.noBangku]
      this.$store.dispatch('addPendingBus', temp)
    },
    bus() {
    ...
    sisaBangku() {
      ...
      newBangku.forEach((element, index) => {
        if (element.user != 'none') {
          sisaBangku -= -1
        } else {
          oldListBangku.push(index + 1)
        }
      })
      this.listBangku = oldListBangku
      return sisaBangku
    }
  },
  methods: {
